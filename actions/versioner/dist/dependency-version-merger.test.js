...
describe('DependencyVersionMerger', () => {
    ...
    it('should merge dependencies with their latest versions', () => {
        ...
        expect(result[0]).toEqual(Object.assign(Object.assign({}, mockDependencies[0]), { latestVersion: 'v4', isUpToDate: false }));
        expect(result[1]).toEqual(Object.assign(Object.assign({}, mockDependencies[1]), { latestVersion: 'v3', isUpToDate: true }));
    });
